...
export interface ApiFooterItemFooterItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'footer-items';
    singularName: 'footer-item';
  };
  options: {
...
export interface ApiFooterSettingFooterSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    additionalText: Schema.Attribute.RichText &
      Schema.Attribute.DefaultTo<'This is additional footer text'>;
    copyrightText: Schema.Attribute.Text &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u00A9 Nikolai Ahlhelm | 2026'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiNavItemNavItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nav_item: Schema.Attribute.Relation<'manyToOne', 'api::nav-item.nav-item'>;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultPage: Schema.Attribute.Relation<'oneToOne', 'api::page.page'>;
    defaultTheme: Schema.Attribute.Enumeration<['system', 'light', 'dark']> &
      Schema.Attribute.Required &
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'My Site'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
